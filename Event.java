public class Event {
    ...
    public void setSport_event_id(String sport_event_id) { this.sport_event_id = sport_event_id; }
    ...
    public void setCompetition_id(String competition_id) { this.competition_id = competition_id; }
    ...
    public float getProbability_home_team_winner() { return probability_home_team_winner;}
    public void setProbability_home_team_winner(float probability_home_team_winner) { this.probability_home_team_winner = probability_home_team_winner; }
    public float getProbability_draw() { return probability_draw; }
    public void setProbability_draw(float probability_draw) { this.probability_draw = probability_draw; }
    public float getProbability_away_team_winner() { return probability_away_team_winner; }
    public void setProbability_away_team_winner(float probability_away_team_winner) { this.probability_away_team_winner = probability_away_team_winner; }
}
